...
export const AuthModal = ({
  ...
  const handlePasswordLogin = async (e) => {
    ...
    try {
      ...
      if (
        err.message &&
        err.message.includes("Không thể kết nối máy chủ")
      ) {
        console.warn(
          "Backend offline, running fallback mock login..."
        );
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      if (
        ...
        console.warn(
          "Backend offline, running fallback mock registration..."
        );
  ...
  const handleGoogleLogin = async (customEmail = null) => {
    ...
    try {
      ...
      if (res.token && res.user) {
        ...
        Swal.fire({
          title: "Đăng nhập thành công!",
          text: `Chào mừng ${res.user.name} đến với TripNest.`,
          icon: "success",
          timer: 2000,
          showConfirmButton: false,
        });
              ...
              >
                ...
                <a
                  ...
                  onClick={(e) => {
                    ...
                    Swal.fire(
                      "Điều khoản dịch vụ",
                      "Điều khoản sử dụng nền tảng TripNest dành cho Khách hàng và Chủ nhà.",
                      "info"
                    );
                  }}
                  style={{
                ...
                <a
                  ...
                  onClick={(e) => {
                    ...
                    Swal.fire(
                      "Chính sách bảo mật",
                      "Chính sách thu thập và mã hóa bảo mật thông tin cá nhân của TripNest.",
                      "info"
                    );
                  }}
                  style={{
