...
export const AuthModal = ({
  ...
  const handlePasswordLogin = async (e) => {
    ...
    try {
      // Gọi API đăng nhập hoặc đăng nhập Google tương thích
      const googlePayload = {
        email: email.trim(),
        password: password,
        google_id: 'local-auth-' + email.trim(),
      ...
      setError('Đăng nhập thất bại: ' + (err.message || 'Vui lòng kiểm tra lại email & mật khẩu'));
    } finally {
      setLoading(false);
    }
  };
